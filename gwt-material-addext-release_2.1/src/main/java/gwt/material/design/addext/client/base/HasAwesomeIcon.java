...
import gwt.material.design.addext.client.ui.MaterialAwesomeIcon;
 ...
 *
 */
public interface HasAwesomeIcon {

	/**
	 * Get the icon widget.
	 */
	MaterialAwesomeIcon getIcon();
	 ...
	 */
	void setIconType(AwesomeIconType iconType);
